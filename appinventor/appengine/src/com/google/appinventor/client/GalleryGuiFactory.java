...
public class GalleryGuiFactory implements GalleryRequestListener {
  ...
  private final int MAX_FEAT_DESC_LENGTH = 250;
...
//      gaw.numCommentsLabel.addStyleName("gallery-meta");
  ...
  public void generateFeaturedAppList(List<GalleryApp> apps,
    ...
    for (final GalleryApp app : apps) {
      ...
      //just in case there is a featured app with no description
      if (featuredDescription == null){
        featuredDescription = "No featured description";
      }
      //This takes care of overflow for a large description
      if (featuredDescription.length() > MAX_FEAT_DESC_LENGTH){
        //Cut description and add "..." to show continuity
        featuredDescription = featuredDescription.substring(0, MAX_FEAT_DESC_LENGTH) + "...";
      }
